#!/usr/bin/env python
"""Provides Self Attention General Adversarial Network, class to be used for training.

The Self-Attention Generative Adversarial Network, allows for attention driven long-range
dependency modelling for image generation tasks. Traditional convolutional GANs generate 
high-resolution details as a function of spatially local points in lower-resolution feature maps.
"""
from layers import *
import numpy as np
import time
...
class SAGAN_model(object):
    def __init__(self, args):
        ...
        # divide trainable variables into groups for G
    ...
    def generator(self, z, reuse=False):
        with tf.variable_scope("generator", reuse=reuse):
            ...
            # Self Attention General Adversarial Network Generator
    ...
    def discriminator(self, x, reuse=False):
        with tf.variable_scope("discriminator", reuse=reuse):
            ...
            # Self Attention General Adversarial Network Discriminator
            x = attention(x, ch, is_training=self.is_training, scope="attention", reuse=reuse)
