#!/usr/bin/env python
"""Provides BIG General Adversarial Network, class for Generative Art.

The BigGAN is an approach to pull together a suite of recent best practices
in training class-conditional images and scaling up the batch size and number
of model parameters. The result is the routine generation of both high-resolution 
(large) and high-quality (high-fidelity) images..
"""
